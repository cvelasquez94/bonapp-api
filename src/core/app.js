...
async function app() {
  ...
  fastify.register(require('../services/users/getUsers'), { prefix: fastify.config.prefix })
  fastify.register(require('../services/login/signIn'), { prefix: fastify.config.prefix })
  fastify.register(require('../services/checkList/getCheckList'), { prefix: fastify.config.prefix })
  ...
  fastify.register(require('../services/checkList/getIncompleteAndCompleteS'), { prefix: fastify.config.prefix })
  fastify.register(require('../services/documents/postImage'), { prefix: fastify.config.prefix })
  fastify.ready(err => {
    if (err) throw err
  })
